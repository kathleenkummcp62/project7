...
func setupProxyServer(t *testing.T) (*Server, func()) {
	t.Helper()
	if os.Geteuid() == 0 {
...
func tableExistsProxy(t *testing.T, db *sql.DB, name string) bool {
	var exists bool
